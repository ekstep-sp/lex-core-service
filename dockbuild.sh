...
docker build --no-cache -t lexplatform.azurecr.io/lex-core-service:space-v3-sprint-1.4 .
docker push lexplatform.azurecr.io/lex-core-service:space-v3-sprint-1.4
